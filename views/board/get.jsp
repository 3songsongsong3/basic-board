...
<!--                    DataTables Advanced Tables -->
            ...
            <!-- 스프링 시큐리티 인증 설정 추가 - 로그인한 사용자가 작성한 글에만 수정 버튼 표시 -->
...
//           function(list){
   ...
   <!--스프링 싴뉴리티 인증 설정추가 로그인한사용자가 잓ㅇ한 글에 작성장ㅁㄴㅇㅁㄴㅇㅁㅇㅁㅇ-->
     var replyer =null; //작성자 저장 변수
    <sec:authorize access="isAuthenticated()">
...
//                  showList(1);   //신규 댓글 목록 가져오기
    ...
    modalModBtn.on('click', function(){
       ...
       var originalReplyer = modalInputReplyer.val();//댓글 작성자
...
//                  showList(1);         //수정 댓글 목록 가져오기
    ...
    modalRemoveBtn.on('click', function(){
       ...
       //replyService의 remove 함수 호출- 댓글 작성자 추가
        replyService.remove(rno,originalReplyer, function(count){
